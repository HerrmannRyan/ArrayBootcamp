		...
		public static void displayUsersFavoriteCandy()
			{
				...
				System.out.println("Sweet! You have " + (numberOfFavoriteCandies - 1) + " favorite candies. Please name them down below on separate lines.");	
		...
		public static void totalUpEvenAndOddNumbers()
			{
				...
				System.out.println("Hello Please insert 8 numbers for me to add the even and odd numbers.");
				...
				System.out.println("The sum of the even numbers is " + sumOfEvenNumbers + ", and the sum of the odd numbers is " + sumOfOddNumbers);
